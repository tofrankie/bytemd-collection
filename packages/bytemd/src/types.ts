...
export interface BytemdEditorContext extends EditorUtils {
  codemirror: BytemdCodeMirrorCompat
  /**
   * Editor adapter that preserves ByteMD's high-level editing semantics
   * while running on top of CodeMirror 6.
   */
  editor: BytemdEditorAdapter
  /**
   * The root element
   */
  root: HTMLElement
...
type BytemdActionHandler =
  | {
      ...
      click: Listener
      /**
       * Keyboard shortcut shown in the help panel and mapped to the
       * CodeMirror 6 keymap bridge.
