...
- 新增 `@tofrankie/bytemd-plugin-highlight` 子包，为 ByteMD Viewer 中的代码块提供基于最新版 `highlight.js` 的语法高亮。
...
- 用户可通过 `@tofrankie/bytemd-plugin-highlight` 导入插件，并自行导入所需的 `highlight.js` 主题样式。
